...
function VerifyCode() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 text-slate-900">
            <Link to={purpose === 'reset' ? "/auth/forgot-password" : "/auth/signup"} className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors mb-8 cursor-pointer">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back
            </Link>

            <div className="mb-10 text-center">
                <h1 className="font-['Outfit'] text-3xl font-bold mb-3 text-black">Check your email</h1>
