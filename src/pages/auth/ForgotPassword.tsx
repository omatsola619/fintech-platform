...
function ForgotPassword() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 text-slate-900">
            ...
            <div className="mb-10">
                <h1 className="font-['Outfit'] text-3xl font-bold mb-3 text-black">Reset password</h1>
                <p className="text-slate-600">Enter the email associated with your account and we'll send you a 6-digit verification code.</p>
            </div>
