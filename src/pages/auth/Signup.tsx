    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="mb-10 text-center">
                <h1 className="font-['Outfit'] text-3xl font-bold mb-3 text-black">Create your account</h1>
                <p className="text-slate-600">Start integrating payment providers in minutes</p>
            </div>
            ...
            <div className="mt-10 text-center text-sm text-slate-600">
                ...
                <Link to="/auth/login" className="font-semibold text-blue-600 hover:text-blue-500 cursor-pointer">
                    Sign in instead
                </Link>
            </div>
        </div>
