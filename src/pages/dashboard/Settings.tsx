...
function Settings() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Header */}
            <div>
                <h1 className="font-['Outfit'] text-2xl sm:text-3xl font-bold text-black mb-1">Settings</h1>
                <p className="text-slate-600 text-sm sm:text-base">Manage your account settings, team members, and preferences.</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <nav className="flex md:flex-col gap-2 overflow-x-auto pb-4 md:pb-0 md:w-64 shrink-0 no-scrollbar">
                  ...
                  `}
                            >
                                <TabIcon className={`w-4 h-4 ${activeTab === tab.id ? 'text-blue-600' : 'text-slate-400'}`} />
                                {tab.label}
                            </button>
                        );
                    })}
                ...
                <div className="flex-1 space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                                <div className="px-6 py-5 border-b border-slate-200">
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">Manage devices logged into your account.</p>
                                </div>
                    ...
                    {activeTab !== 'general' && activeTab !== 'apikeys' && activeTab !== 'notifications' && (
                        <div className="h-64 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-center p-6 bg-slate-50/50">
                            ...
                            <h3 className="text-base font-semibold text-slate-900 mb-1 capitalize">{activeTab} Settings</h3>
                    ...
                    {activeTab === 'apikeys' && (
                        <div className="space-y-6">
                            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                                <div className="px-6 py-5 border-b border-slate-200">
                                    <h3 className="text-sm font-semibold text-slate-900">Provider Integrations</h3>
                                    <p className="text-xs text-slate-500 mt-1">Manage connection status and API keys for supported providers.</p>
                                </div>
                                <div className="divide-y divide-slate-100">
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-medium text-slate-900">Paystack</h4>
                                        ...
                                        <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs text-slate-500 font-medium uppercase tracking-wider">Secret Key</span>
                                                <code className="text-sm text-slate-700 font-mono">sk_live_•••••••••••••••••••••8a4b</code>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-medium text-slate-900">Flutterwave</h4>
                                                    <div className="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs text-slate-500 font-medium uppercase tracking-wider">Secret Key</span>
                                                <code className="text-sm text-slate-400 font-mono">Not configured</code>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                                <div className="px-6 py-5 border-b border-slate-200">
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">Configure automated notifications for provider degradation.</p>
                                </div>
                                <div className="p-6 space-y-6">
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-slate-900">Success Rate Alerts</p>
                                                <p className="text-xs text-slate-500 mt-0.5">Receive an email if a provider's success rate falls below the threshold.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="pt-4 border-t border-slate-100 flex items-center gap-4">
                                        <label className="text-sm font-medium text-slate-700 whitespace-nowrap">Alert Threshold (%)</label>
